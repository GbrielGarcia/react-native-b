...
function OneSelection({ navigation }) {
    ...
    const consul = () => {
        ...
        if (parseInt(number) >= 0) {
            setResult(`El numero ingresado es ${number} positivo`)
        } else {
            setResult(`El numero ingresado es ${number} negativo`)
        }
    ...
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text style={styles.title}>Positivonegativo: Ingresar un número y presentar si es positivo o negativo.</Text>
